...
public class UserProviderTest extends InstrumentationTestCase {
    ...
    public void testSave(){
        ...
        Location location = new Location(2, "Brisbane", 32.5677878F, -122.454643F);
        ...
        assertEquals(32.5677878F, savedLocation.getLatitude());
        assertEquals(-122.454643F, savedLocation.getLongitude());
